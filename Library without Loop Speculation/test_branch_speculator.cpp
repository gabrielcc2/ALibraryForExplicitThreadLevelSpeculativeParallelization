...
int main()
{
	...
	/*Lo que este programa hará es modificar los valores de aux1 en la siguiente manera:
	  Primero en el programa principal se harán varias escrituras y lecturas, luego llega a una condición de
	*/
	...
	cout<<"PB-2 wrote aux1[0]= "<<aux1[0]<<" "<<aux1[1]<<endl; //Deberia ser 14 y 18.
