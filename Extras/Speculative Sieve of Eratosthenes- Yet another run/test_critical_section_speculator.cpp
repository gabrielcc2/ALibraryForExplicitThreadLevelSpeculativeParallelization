...
void* funcion_bloqueo (void* arg){
	...
	if (pthread_self()==t0){
		cout<<"entra pb..."<<endl;
		p=b.speculate((void*&)aux, funcion_pb, arg);
	}
	else if (pthread_self()==t1){
		cout<<"entra b1..."<<endl;
		p=b.speculate((void*&)aux, funcion_b1, arg);
	}
	else if (pthread_self()==t2){
		cout<<"entra b2..."<<endl;
		p=b.speculate((void*&)aux, funcion_b2, arg);
	}	
	else if (pthread_self()==t3){
		cout<<"entra b3..."<<endl;
		p=b.speculate((void*&)aux, funcion_b3, arg);
	}
	else if (pthread_self()==t4){
		cout<<"entra b4..."<<endl;
		p=b.speculate((void*&)aux, funcion_b4, arg);
	}
	return p;
}
