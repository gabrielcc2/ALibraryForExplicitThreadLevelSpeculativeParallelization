...
int main()
{
	...
	cout<<"La ventaja más notoria de la especulación, aún bajo las limitaciones de esta implementación, proviene de permitir el solapamiento de todas las operaciones sobre data no compartida."<<endl;
